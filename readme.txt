...
Tags: instagram, instafeed, instagram feed
...
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Configure your feed into the administrator panel
1. Place the shortcode '[sc_instafeed]' wherever you want, in your pages/posts OR place the following code into your php file:
...
Check the options page, into the administrator panel and select the options the way you want
